...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  header { background: linear-gradient(135deg, #1a0800 0%, #0d0d0d 100%); padding: 20px 20px 16px; border-bottom: 1px solid var(--border); position: sticky; top: 0; z-index: 100; backdrop-filter: blur(10px); position: relative; }
